...
full_join(df, maxdt20 %>% select(-tomst_id) %>% mutate(visit = 1) %>% rename(datetime = maxdt)) %>% 
  group_by(site) %>% 
  mutate(visit_lag = lag(visit)) %>% 
  mutate(across(T1:moist, ~ifelse(is.na(visit) & is.na(visit_lag), ., NA))) %>%
  select(-visit, -visit_lag) %>% as.data.table() -> df

# Remove the measurements of the time of the 2021 visiting
# as reading the logger may influence the measurements
# Because of the problems in the field, here we will have 1 hour buffer added
maxdt %>% mutate(maxdt = maxdt - hours(1)) -> maxdt
full_join(df, maxdt %>% select(-tomst_id)) %>% 
...
office <- c(as_date(as_date(min(df$datetime)):as_date("2019-06-21")))
probls <- c(as_date(as_date("2019-07-03"):as_date("2019-09-23")),
            as_date(as_date("2020-10-02"):as_date("2021-05-11")))
hattu <- c()
...
office <- c(as_date(as_date(min(df$datetime)):as_date("2019-06-20")))
probls <- c()
hattu <- c()
...
office <- c(as_date(as_date(min(df$datetime)):as_date("2019-06-22")))
probls <- c()
hattu <- c()
...
office <- c(as_date(as_date(min(df$datetime)):as_date("2019-06-19")))
probls <- c()
hattu <- c()
...
office <- c(as_date(as_date(min(df$datetime)):as_date("2019-06-21")))
probls <- c(as_date(as_date("2019-08-07"):as_date("2019-10-06")),
            as_date(as_date("2020-06-10"):as_date("2020-09-23")))
hattu <- c()
...
office <- c(as_date(as_date(min(df$datetime)):as_date("2019-06-20")))
probls <- c(as_date(as_date("2020-03-24"):as_date("2020-06-16")),
            as_date(as_date("2020-08-03"):as_date("2020-09-22")))
hattu <- c()
...
office <- c(as_date(as_date(min(df$datetime)):as_date("2019-06-20")))
probls <- c(as_date(as_date("2021-04-04"):as_date("2021-05-09")))
hattu <- c()
...
office <- c(as_date(as_date(min(df$datetime)):as_date("2019-06-21")))
probls <- c(as_date(as_date("2019-08-10"):as_date("2019-10-05")))
hattu <- c()
...
office <- c(as_date(as_date(min(df$datetime)):as_date("2019-06-18")))
probls <- c()
hattu <- c()
...
office <- c(as_date(as_date(min(df$datetime)):as_date("2019-10-06")))
probls <- c()
hattu <- c()
...
office <- c(as_date(as_date(min(df$datetime)):as_date("2019-06-19")))
probls <- c(as_date(as_date("2021-04-22"):as_date("2021-05-10")))
hattu <- c()
...
office <- c(as_date(as_date(min(df$datetime)):as_date("2019-06-21")))
probls <- c(as_date(as_date("2020-02-03"):as_date("2020-09-23")))
hattu <- c()
...
office <- c(as_date(as_date(min(df$datetime)):as_date("2019-06-22")))
probls <- c(as_date(as_date("2020-09-17"):as_date("2020-09-26")))
hattu <- c()
...
office <- c(as_date(as_date(min(df$datetime)):as_date("2019-06-20")))
probls <- c(as_date(as_date("2020-08-04"):as_date("2020-09-22")))
hattu <- c()
...
office <- c(as_date(as_date(min(df$datetime)):as_date("2019-06-21")))
probls <- c(as_date(as_date("2020-06-09"):as_date("2020-09-23")))
hattu <- c()
...
office <- c(as_date(as_date(min(df$datetime)):as_date("2019-06-19")))
probls <- c(as_date(as_date("2021-08-03"):as_date("2021-10-26")))
hattu <- c()
