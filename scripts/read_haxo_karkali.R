...
f <- list.files("data", pattern = "HAXO", full.names = T, recursive = T)
...
old_times[old_times$site == 20, "min_time"] <- as_datetime("2020-09-22 11:00:00", tz = "Etc/GMT-2")
old_times[old_times$site == 20, "max_time"] <- as_datetime("2021-10-26 13:00:00", tz = "Etc/GMT-2")
old_times[old_times$site == 34, "min_time"] <- as_datetime("2020-09-22 11:00:00", tz = "Etc/GMT-2")
old_times[old_times$site == 25, "max_time"] <- as_datetime("2021-10-26 13:00:00", tz = "Etc/GMT-2")
old_times[old_times$site == 10, "max_time"] <- as_datetime("2021-10-26 13:00:00", tz = "Etc/GMT-2")
...
df %>% filter(datetime > "2019-06-01",
              datetime < "2021-11-04") -> df
