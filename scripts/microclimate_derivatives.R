...
d1 %>% mutate(snow_days = ifelse(is.na(snow_days) & (T2_ft > 0 | days_in_hydro_year > 300), 0, snow_days),
              max_snow_period = ifelse(is.na(max_snow_period) & (T2_ft > 0 | days_in_hydro_year > 300), 0, max_snow_period),
              n_snow_period = ifelse(is.na(n_snow_period) & (T2_ft > 0 | days_in_hydro_year > 300), 0, n_snow_period),
              last_snow_doy = ifelse(is.na(last_snow_doy) & (T2_ft > 0 | days_in_hydro_year > 300), 0, last_snow_doy)) -> d1

d1 %>% mutate(deep_snow_days_T2 = ifelse(is.na(deep_snow_days_T2) & (T2_ft > 0 | days_in_hydro_year > 300), 0, deep_snow_days_T2),
              max_deep_snow_period_T2 = ifelse(is.na(max_deep_snow_period_T2) & (T2_ft > 0 | days_in_hydro_year > 300), 0, max_deep_snow_period_T2),
              n_deep_snow_period_T2 = ifelse(is.na(n_deep_snow_period_T2) & (T2_ft > 0 | days_in_hydro_year > 300), 0, n_deep_snow_period_T2),
              last_deep_snow_doy_T2 = ifelse(is.na(last_deep_snow_doy_T2) & (T2_ft > 0 | days_in_hydro_year > 300), 0, last_deep_snow_doy_T2)) -> d1

d1 %>% mutate(deep_snow_days_T3 = ifelse(is.na(deep_snow_days_T3) & (T2_ft > 0 | days_in_hydro_year > 300), 0, deep_snow_days_T3),
              max_deep_snow_period_T3 = ifelse(is.na(max_deep_snow_period_T3) & (T2_ft > 0 | days_in_hydro_year > 300), 0, max_deep_snow_period_T3),
              n_deep_snow_period_T3 = ifelse(is.na(n_deep_snow_period_T3) & (T2_ft > 0 | days_in_hydro_year > 300), 0, n_deep_snow_period_T3),
              last_deep_snow_doy_T3 = ifelse(is.na(last_deep_snow_doy_T3) & (T2_ft > 0 | days_in_hydro_year > 300), 0, last_deep_snow_doy_T3)) -> d1

# Filter only data with enough days within hydro year
d1 %>% filter(days_in_hydro_year > 300) %>% 
  arrange(site, hydro_year) -> d1
